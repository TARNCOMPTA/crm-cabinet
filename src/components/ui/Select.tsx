    ...
    return (
      <div className="w-full">
        ...
        <select
          id={id}
          ref={ref}
          className={cx(`w-full px-3.5 py-2.5 border rounded-xl focus:outline-hidden focus:ring-2 focus:ring-teal-500/40 focus:border-teal-500 dark:focus:ring-cyan-400/30 dark:focus:border-cyan-400/40 bg-white dark:bg-white/4 text-gray-900 dark:text-slate-100 transition-all duration-200 ${
